...
import { SoundCloudWidget } from '../components';

export default {
  title: 'Example/SoundCloudWidget',
...
}}><SoundCloudWidget {...args} >{args.children}</SoundCloudWidget></div>;

export const Default = Template.bind({});
Default.args = {};

export const ColdplayTrack = Template.bind({});
ColdplayTrack.args = {
